...
import { Box, Button, Overlay, Stack, Text } from "@mantine/core";
...
/** "Abrir en el mapa" — the outline pill that opens directions in Google Maps. */
export function MapButton({ size = "lg", fullWidth }: { size?: string; fullWidth?: boolean }) {
  return (
    <Button
      component="a"
      href={directionsHref}
  ...
  return (
    ...
    >
      {loaded ? (
        ...
        <>
          <Box className="photo-grade" style={{ position: "absolute", inset: 0 }}>
            <Image
          ...
          >
            <Text c="white" fw={600} ff="var(--font-display)" fz="var(--h3)">
              {siteInfo.address}
            </Text>
            <Text c="pine.2" fz="sm" maw={380} lh={1.6}>
